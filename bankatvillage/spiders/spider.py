...
from ..items import BbankatvillageItem
from itemloaders.processors import TakeFirst
import json

pattern = r'(\xa0)?'
base = 'https://www.bankatvillage.com/content/wintrust/bankatvillage/en/small-business/resources/financial-education.article.{}.json?limit=10'

class BbankatvillageSpider(scrapy.Spider):
	name = 'bankatvillage'
	page = 0
	...
	def parse_post(self, response, date, title):
		...
		item = ItemLoader(item=BbankatvillageItem(), response=response)
